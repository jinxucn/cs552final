package edu.rutgers.cs552.im.server.messagehandler.heartbeat;

import edu.rutgers.cs552.im.common.codec.Invocation;
import edu.rutgers.cs552.im.common.dispatcher.MessageHandler;
import edu.rutgers.cs552.im.server.message.heartbeat.HeartbeatRequest;
import edu.rutgers.cs552.im.server.message.heartbeat.HeartbeatResponse;
